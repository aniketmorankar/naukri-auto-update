...
# Update your naukri username and password here
username = "aniketmorankar@gmail.com"  # Replace with your Naukri email
password = "Ani@8080662121"           # Replace with your Naukri password
mob = "8080662121"                   # Replace with your mobile number

# Add folder Path of your resume
originalResumePath = r"C:\Users\pratik\Downloads\Resume\original_resume.pdf"    # Replace with your original resume path
# Add Path where modified resume should be saved
modifiedResumePath = r"C:\Users\pratik\Downloads\Resume\modified_resume.pdf"    # Replace with modified resume save path
